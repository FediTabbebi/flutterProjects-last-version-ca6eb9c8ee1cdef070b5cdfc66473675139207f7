...
class APIOffreConductor {
  static Future<List<AllOffers>> getAllOffers(userId, conductorId) async {
    ...
    var request = http.Request(
        'POST', Uri.parse('http://192.168.1.44:4000/conducteur/offer/getall'));
  ...
  static RegisterOffre(
    ...
    var request = http.Request('POST',
        Uri.parse('http://192.168.1.44:4000/conducteur/offer/register'));
    request.body = json.encode({
      "offer": offreID,
      "conducteur": ConductorId,
      "truck": TruckID,
  ...
  static Future<List<RegisteredOffers>> allRegisteredOffers(
    ...
    var request = http.Request(
        'POST',
        Uri.parse(
            'http://192.168.1.44:4000/conducteur/offer/getacceptedoffersbyconducteur'));
    request.body =
  ...
  static DeleteOffre(offreID) async {
    ...
    var request = http.Request('DELETE',
        Uri.parse('http://192.168.1.44:4000/conducteur/offer/delete'));
