...
class APIServiceUser {
  static Future<void> login(email, password) async {
    ...
    var request = http.Request(
        'POST', Uri.parse('http://192.168.1.11:4000/users/login'));
  ...
  static Register(username, email, password) async {
    var headers = {'Content-Type': 'application/json'};
    var request = http.Request(
        'POST', Uri.parse('http://192.168.1.11:4000/users/register'));
    request.body = json
  ...
  static Update(userID, Username) async {
    var headers = {'Content-Type': 'application/json'};
    var request = http.Request(
        'PATCH', Uri.parse('http://192.168.1.11:4000/users/update'));
  ...
  //   var headers = {'Content-Type': 'application/json'};
  //   var request =
  //       http.Request('POST', Uri.parse("http://192.168.1.11:4000/user/status"));
